...
<div class="row" style="background-color:#003399">
	<div class="col-lg-12" >
		...
		<h1><font color="white">Tambah Ebook</font></h1>
	</div>
	<!-- /.col-lg-12 -->
</div>
<br />
		...
		<div class="panel panel-primary">
			<div class="panel-heading">
				<div class="row">					
				 ...
				 <form role="form" action="<?php echo base_url("index.php/pages/insert_ebook")?>" method="POST" enctype="multipart/form-data" name="myform" id="myform">
