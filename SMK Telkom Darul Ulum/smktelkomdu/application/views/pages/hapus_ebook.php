                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
									...
									<?php
											...
											foreach($result as $data)
											{
												...
												echo "<form role=\"form\" action=\"".base_url('index.php/pages/hapus_ebook_detail')."/".$data['ID_EBOOK']."\"> ";												
												echo "<td><button type=\"submit\" class=\"btn btn-danger\">Lihat Detail</button></td>";
												echo "</form>";												
											}
									?>									
                                </table>
