            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
						...
						<li>
                            <a class="" href="<?php echo base_url("index.php/pages/data_ebook")?>"><i class="fa fa-files-o fa-fw"></i> Lihat Data Ebook</a>
                        </li>
						<li>							                            
							<a href="#"><i class="fa fa-sitemap fa-fw"></i> Pesanan Ebook <span class="fa arrow"></span></a>
							<ul class="nav nav-second-level">
								<li>
									<a class="" href="<?php echo base_url("index.php/pages/pesan_ebook")?>"> Pesan Ebook</a>
								</li>
								<li>
									 <a class="" href="<?php echo base_url("index.php/pages/status_pesanan_saya")?>"> Status Pesanan Saya</a>
								</li>
							</ul>
                        </li>
						<li>							                            
							<a href="#"><i class="fa fa-edit fa-fw"></i> Kontributor Ebook <span class="fa arrow"></span></a>
							<ul class="nav nav-second-level">
								<li>
									<a class="" href="<?php echo base_url("index.php/pages/kontributor_ebook")?>"> Kontribusi Ebook</a>
								</li>
								<li>
									 <a class="" href="<?php echo base_url("index.php/pages/lihat_kontribusi_saya")?>">Lihat Kontribusi Saya</a>
								</li>
								<li>
									 <a class="" href="<?php echo base_url("index.php/pages/status_kontribusi_saya")?>"> Status Kontribusi Saya</a>
								</li>
							</ul>
                        </li>
